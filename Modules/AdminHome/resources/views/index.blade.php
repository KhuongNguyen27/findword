            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="">
                        ...
                        <h4 class="mb-0 text-warning">{{$total_employeer_create_today}}</h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="">
                        ...
                        <h4 class="mb-0 text-primary">{{$total_staff_create_today}}</h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="">
                        ...
                        <h4 class="mb-0 text-success">{{$total_employeer}}</h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="">
                        ...
                        <h4 class="mb-0 text-danger">{{$total_staff}}</h4>
                    </div>
                ...
                <div class="team-list">
                    <div
                        ...
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$total_employee_access_website}}</span>
                        </div>
                    </div>
                    <hr>
                    <div class="d-flex align-items-center gap-3 border-start border-danger border-4 border-0 px-2 py-1">
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$total_staff_access_website}}</span>
                        </div>
                    </div>
                    <hr>
                    <div
                        ...
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$total_employee_in_website}}</span>
                        </div>
                    </div>
                    <hr>
                    <div
                        ...
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$total_staff_in_website}}</span>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="d-flex align-items-center gap-3 border-start border-info border-4 border-0 px-2 py-1">
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$total_view_jobs}}</span>
                        </div>
                    </div>
                    <hr>
                    <div class="d-flex align-items-center gap-3 border-start border-info border-4 border-0 px-2 py-1">
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$total_job_has_aplicaton}}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="team-list">
                    <div
                        ...
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$retention_rate_employee}}</span>
                        </div>
                    </div>
                    <hr>
                    <div class="d-flex align-items-center gap-3 border-start border-danger border-4 border-0 px-2 py-1">
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$retention_rate_staff}}</span>
                        </div>
                    </div>
                    <hr>
                    <div
                        ...
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$churn_rate_employee}}</span>
                        </div>
                    </div>
                    <hr>
                    <div
                        ...
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$churn_rate_staff}}</span>
                        </div>
                    </div>
                    <hr>
                    <div class="d-flex align-items-center gap-3 border-start border-info border-4 border-0 px-2 py-1">
                        <div class="flex-grow-1">
                            ...
                            <span class="">{{$retention_rate_jobs_has_cv_aplication}}</span>
                        </div>
                    </div>
                    <hr>
                    <div class="d-flex align-items-center gap-3 border-start border-info border-4 border-0 px-2 py-1">
