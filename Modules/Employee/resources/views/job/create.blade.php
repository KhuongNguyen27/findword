                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12" style="margin-bottom:3%!important">
                                            ...
                                            <select name="formwork_id" class="chosen-select">
                                                @foreach ($param['formworks'] as $formwork)
                                                    <option value="{{ $formwork->id }}">{{ $formwork->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @if ($errors->any())
                                        ...
                                        <div class="form-group col-lg-6 col-md-12" style="margin-bottom: 3%!important;">
                                            ...
                                            <select name="country" class="chosen-select" id="country">
                                                <option id="vn" value="VN"
                                                    {{ old('country') == 'VN' ? 'selected' : '' }}>
                                                    Trong nước</option>
                                                <option id="nn" value="NN"
                                                    {{ old('country') == 'NN' ? 'selected' : '' }}>
                                                    Ngoài nước</option>
                                            </select>
                                        ...
                                        <div class="form-group col-lg-12 col-md-12" style="margin-bottom:3%!important">
                                            ...
                                            <textarea name="description" id="description" placeholder="Mô tả...">{{ old('description') }}</textarea>
                                            @if ($errors->any())
                                                <p style="color:red">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12">
                                            ...
                                            <textarea name="requirements" id="requirements" placeholder="Yêu cầu...">{{ old('requirements') }}</textarea>
                                            @if ($errors->any())
                                                <p style="color:red">
                                    ...
                                    <div class="widget-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6 col-md-12" style="margin-bottom:3%!important">
                                                ...
                                                <input id="price" type="text" value="{{ old('price') }}"
                                                    name="price" placeholder="Giá..." readonly>
                                                @if ($errors->any())
                                        ...
                                        <div class="widget-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6 col-md-12"
                                                    style="margin-bottom:3%!important">
                                                    <label>Số ngày :</label>
                                                    <input type="number" value="{{ old('number_day') }}"
                                                        class="number_day" name="number_day" id="nameInput"
