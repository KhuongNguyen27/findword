                ...
                <div class="ls-widget">
                    <div class="tabs-box">
                        <div class="widget-title">
                            <h4>{{ __('work_list') }}</h4>
                            <form class="form-search" action="{{ route('employee.referred.jobs') }}">
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <ul class="option-list">
                                                    <li>{{ $job->user_cvs_count }} {{ __('profile') }}</li>
                                                    <li><a href="{{ route('employee.referred', $job->id) }}"
