    ...
    <div class="form-inner">
        ...
        <form action="{{ route('staff.postLogin')}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input id="password-field" type="password" name="password" value="" placeholder="{{ __('password') }}" value="{{ old('Password') }}">
                @if ($errors->any())
        ...
        <div class="bottom-box">
            <div class="text">{{ __('you_dont_have_an_account') }}? <a href="{{ route('staff.register')}}">{{ __('register') }}</a></div>
            <div class="divider"><span>{{ __('or') }}</span></div>
            <div class="btn-box row">
                <div class="col-lg-6 col-md-12">
                    <a href="#" class="theme-btn social-btn-two facebook-btn"><i class="fab fa-facebook-f"></i>{{ __('facebook_login') }}</a>
                </div>
                <div class="col-lg-6 col-md-12">
                    <a href="#" class="theme-btn social-btn-two google-btn"><i class="fab fa-google"></i>{{ __('gmail_login') }}</a>
                </div>
            </div>
        </div>
    </div>
