                            ...
                            <div class="row">
                                ...
                                @foreach ($items as $item)
                                    @if (array_search($item->id, $package_current))
                                        <div class="pricing-table col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            <div class="inner-box">
                                                ...
                                                <div class="price">{{ number_format($item->price) }}<span
                                                        class="duration">Điểm/
                                                        tháng</span></div>
                                                <div class="table-content">
                                                    <ul class="ul-description">
                                                        @foreach ($item->job_package as $package)
                                                            <li><span>Miễn phí {{ $package->amount }}
                                                                    {{ $package->job_package->name }}/
                                                                    tháng</span></li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                    ...
                                    @elseif($item->id == $item::NORMAL)
                                        <div class="pricing-table col-lg-3 col-md-6 col-sm-12">
                                            <div class="inner-box">
                                                <div class="title">
                                                    <h2 class="text-center">{{ $item->name }}1</h2>
                                                </div>
                                                <div class="price" >{{ number_format($item->price) }}<span
                                                        class="duration">P /
                                                        tháng</span>
                                            ...
                                            @endforeach --}}
                                                ...
                                                <div class="table-footer">
                                                    @if (Auth::user()->verify == $item::ACTIVE)
                                                        <a href="#" class="theme-btn btn-style-three">Tài khoản đã
                                                            được xác thực</a>
                                                    @else
                                    ...
                                    @else
                                        <div class="pricing-table col-lg-3 col-md-6 col-sm-12">
                                            <div class="inner-box">
                                                <div class="title">
                                                    <h2 class="text-center">{{ $item->name }}2</h2>
                                                </div>
                                                <div class="price">{{ number_format($item->price) }}<span
                                                        class="duration">P /
                                                        tháng</span></div>
