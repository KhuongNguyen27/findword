            ...
            @if (!isset($country) || true)
                <div class="form-group col">
                    ...
                    <select name="province_id" class="form-select chosen-select">
                        ...
                        @if (!request()->routeIs('jobs.vnjobs'))
                ...
                <div class="form-group col location">
                    ...
                    <select name="wage_id" class="form-select chosen-select">
                        ...
                        @foreach ($wages as $wage)
                            <option @selected($wage->id == request()->wage_id) value="{{ $wage->id }}">{{ $wage->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col location">
                    ...
                    <select name="career_id" class="form-select chosen-select">
                        ...
                        @foreach ($careers as $career)
                            <option @selected($career->id == request()->career_id) value="{{ $career->id }}">{{ $career->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
