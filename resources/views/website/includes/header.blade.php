...
<style>
    ...
    margin-top: 3px;
        ...
        cursor: pointer;
        /* Đổi con trỏ thành pointer khi hover */
    }

    #mark-all-read:hover {
        color: #0A58CA;
        /* Thay đổi màu chữ thành màu xanh khi hover */
    }
            ...
            <div class="logo-box">
                <div class="logo">
                    <a href="{{ route('home') }}" class="fw-bold fs-4 text-black">
                        <img style="width:250px;margin:-8% 0 -10% -10%" height="100"
                            src="{{ asset('website-assets/images/logo-hd.png') }}">
            ...
            @if (Auth::check())
                @if (Auth::user()->type == 'employee')
                    <a class="menu-btn" href="{{ route('employee.transaction.create') }}">
                        ...
                        <span class="fs-5"
                            style="color:#202124">{{ number_format(Auth::user()->points, 0, '', '.') ?? 0 }}P</span>
                    </a>
                @endif
                            ...
                            @if (session('locale') != 'en')
                                <li>
                                    <a href="{{ route('changeLang', ['lang' => 'en']) }}">
                                        <img class="flag-icon" src="{{ asset('storage/images/gb.svg') }}"
                                            alt="flag-en">
                                        English
                                    </a>
                                </li>
                            ...
                            @if (session('locale') != 'vi')
                                <li>
                                    <a href="{{ route('changeLang', ['lang' => 'vi']) }}">
                                        <img class="flag-icon" src="{{ asset('storage/images/vn.svg') }}"
                                            alt="flag-vn">
                                        Vietnamese
                                    </a>
                                </li>
                            ...
                            @if (session('locale') != 'ja')
                                <li>
                                    <a href="{{ route('changeLang', ['lang' => 'ja']) }}">
                                        <img class="flag-icon" src="{{ asset('storage/images/jp.svg') }}"
                                            alt="flag-jp">
                                        Japanese
                                    </a>
                                </li>
                            ...
                            @if (session('locale') != 'ko')
                                <li>
                                    <a href="{{ route('changeLang', ['lang' => 'ko']) }}">
                                        <img class="flag-icon" src="{{ asset('storage/images/hq.png') }}"
                                            alt="flag-kr">
                                        Korean
                                    </a>
                                </li>
                    ...
                    <ul class="dropdown-menu">
                        @if (Auth::user()->type == 'staff')
                            ...
                            <li class="@if ($currentRouteName == 'staff.profile.index' || $currentRouteName == 'staff.home1') active @endif">
                                <a href="{{ route('staff.profile.index') }}"> <i class="la la-user-alt"></i>Thông tin
                                    cá
                                    nhân</a>
                            </li>
                            <li class="@if ($currentRouteName == 'staff.cv.index') active @endif"><a
                                    href="{{ route('staff.cv.index') }}"><i class="la la-box"></i>Danh sách hồ sơ</a>
                            </li>
                            <li class="@if ($currentRouteName == 'staff.favorite') active @endif"><a
                                    href="{{ route('staff.favorite') }}"><i class="la la-bookmark-o"></i>Việc làm đã
                                    lưu</a>
                            </li>
                        ...
                        @if (Auth::user()->type == 'employee')
                            ...
                            <li>
                            <li><a href="{{ route('employee.profile.index') }}"><i class="la la-user-tie"></i>Hồ
                                    sơ</a></li>
                            <li><a href="{{ route('employee.job.create') }}"><i class="la la-paper-plane"></i>Đăng
                                    Tin</a></li>
                            <li><a href="{{ route('employee.job.index') }}"><i class="la la-briefcase"></i> Quản lý
                                    công việc
                                </a></li>
                            <li><a href="{{ route('employee.cv.index') }}"><i class="la la-box"></i>Quản lý CV</a>
                            </li>
                            <li><a href="{{ route('employee.transaction.index') }}"><i class="la la-box"></i>Quản lý
                                    giao
                                    dịch</a></li>
                        @endif
