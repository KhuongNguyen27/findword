            ...
            <div class="row">
                <div class="big-column col-xl-4 col-lg-3 col-md-12">
                    <div class="footer-column about-widget">
                        ...
                        <p class="address">Địa chỉ trụ sở chính: CM2-03A, khu đô thị Eco Garden, phường Thủy Vân,
                        ...
                        <p class="email-e"><i class="fas fa-envelope email-icon"></i><a
                                href="mailto:info@timviecsieunhanh.vn" class="email">info@timviecsieunhanh.vn
                            </a>
                        </p>
                        <p class="fanpages-f"> <i class="fab fa-facebook-square page-icon"></i><a
                                href="https://www.facebook.com/timviecsieunhanhOfficial"
                                class="fanpages">timviecsieunhanhOfficial</a></p>

                        <p>Số Giấy chứng nhận đăng ký doanh nghiệp: 3301729747.</p>
                        <p>Giấy phép hoạt động dịch vụ việc làm số: 02/2024 cấp bởi Sở Lao động - Thương binh và Xã hội  tỉnh Thừa Thiên Huế</p>
                    </div>
                </div>
                                ...
                                <div class="widget-content">
                                    <ul class="list">
                                        ...
                                        <li><a href="{{route('pages.show','chinh-sach-bao-mat')}}">Chính sách bảo
                                                mật</a></li>
                                        <li><a href="{{route('pages.show','dieu-khoan-su-dung')}}">Điều khoản sử dụng
                                            </a></li>
