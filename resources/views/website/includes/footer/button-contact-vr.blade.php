<div id="button-contact-vr" class="<?php echo $class_active_allinone;?>">
    <div id="gom-all-in-one">
        <!-- v3 -->
        <!-- contact -->
        <?php if(get_option('pzf_contact_link')){ ?>
        ...
        <!-- viber -->
        <?php if(get_option('pzf_viber')){ ?>
        <div id="viber-vr" class="button-contact">
            <div class="phone-vr">
                <div class="phone-vr-circle-fill"></div>
                <div class="phone-vr-img-circle">
                    <a target="_blank"
                        href="viber://add?number=<?php echo preg_replace( '/\D/', '',get_option('pzf_viber')); ?>">
        ...
        <!-- zalo -->
        <?php if(get_option('pzf_zalo')){ ?>
        <div id="zalo-vr" class="button-contact">
            <div class="phone-vr">
                <div class="phone-vr-circle-fill"></div>
                <div class="phone-vr-img-circle">
                    <a target="_blank"
                        href="https://zalo.me/<?php echo preg_replace( '/\D/', '',get_option('pzf_zalo')); ?>">
        ...
        <?php if(get_option('pzf_phone')){ ?>
            ...
            <?php  if(get_option('pzf_phone_bar') == '1'){ ?>
    ...
    <?php if(get_option('pzf_enable_all_in_one')){ ?>
    <div id="all-in-one-vr" class="button-contact">
        ...
        <?php if(get_option('pzf_note_bar_all_in_one') == '1'){ ?>
...
<!-- Facebook Messenger -->
<?php if(get_option('pzf_id_fanpage')){ ?>
    ...
    <div class="fb-customerchat" attribution=setup_tool page_id="<?php echo get_option('pzf_id_fanpage'); ?>"
...
<?php if(get_option('setting_size')){?>
    ...
    <?php  if(get_option('setting_size') < 0.9){ ?>
    <style>
    #button-contact-vr {
        margin: -10px;
    }
    </style>
    <?php  }elseif (get_option('setting_size') > 1.3) {?>
        <style>
        #button-contact-vr {
            margin: 10px;
        }
...
<?php if(get_option('pzf_location_bottom')){ ?>
    <style>
    #button-contact-vr {
        bottom: <?php echo get_option('pzf_location_bottom');
        ?>%;
    }
    </style>
<?php };?>
