                                        ...
                                        <div class="name-wrapper">
                                            ...
                                            <ul class="job-info">
                                                <li>
                                                    ...
                                                    {{ $item->address ? $item->address : '133 lý thường kiệt - đông hà' }}
                                                </li>
                                                <li>
                                                    <span class="icon">
                                                    ...
                                                    {{ $item->phone ? $item->phone : '0987654321' }}
                                                </li>
                                            </ul>
                                            <a href="{{ route('employee.show', ['id' => $item->slug]) }}"
