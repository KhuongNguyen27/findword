                            ...
                            <form action="{{ route('employee.job.update', $job->id) }}" method="post" class="default-form">
                                ...
                                <div class="form-group col-lg-12 col-md-12">
                                  ...
                                  <div class="form-group col-lg-12 col-md-12">
                                    ...
                                    <textarea name="benefits" id="benefits1" placeholder="Quyền lợi...">{{ $job->benefits }}</textarea>
                                    @if ($errors->any())
                                    <p style="color:red">
                                        {{ $errors->first('benefits') }}</p>
                                    @endif
                                </div>
                        </div>
                            ...
                            <div class="tabs-box">
                                <div class="widget-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3 col-md-12">
                                            <label>Ngày hết hạn</label>
                                            <input type="date" name="end_day" value="{{ $job->end_day }}" placeholder=""
