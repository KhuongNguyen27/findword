            ...
            <div class="row">
                ...
                <div class="job-block-outer" style="background-color: {{ $job_detail_header_bg }};">
                    ...
                    <div class="job-detail">
                        <h4 class="job-sub-title">Danh sách hồ sơ hiện tại</h4>
                        <div class="text">
                            <form action="{{ route('cv.store') }}" method="post" id="frmSelectCV">
                                @csrf
                                @if ($errors->any())
                                <p style="color:red">
                                ...
                                <div class="job-detail__info--actions box-apply-current mt-3">
                                    <button id="btnSelectCV" type="submit"
                ...
                <div class="sidebar-column col-lg-4 col-md-12 col-sm-12">
                    <aside class="sidebar">
                        ...
                        <!-- Thông tin chi tiết -->
                        <div
                            class="mt-3 job-detail__box--right job-detail__body-right--item job-detail__body-right--box-general">
